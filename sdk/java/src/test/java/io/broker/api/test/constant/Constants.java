...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: phoenix.tips
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.phoenix.tips
    ...
    // for example: wss://wsapi.phoenix.tips/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.phoenix.tips/openapi/ws
